  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center">
        ...
        <h1 data-aos="zoom-in" className="text-[6.5vw] absolute mb-52 font-bold font-body text-transparent" style={{ WebkitTextStrokeWidth: '1.2px', WebkitTextStrokeColor: '#000', }}>Codey</h1>
        <h1 data-aos="zoom-in" className="absolute text-[1.1vw] mb-14 font-body">Online library that allows people to show their work with the world.</h1>
        <h1 data-aos="zoom-in" className="underline absolute mt-8 text-[1.5vw] font-bold font-body"><a href="https://github.com/codingburgas/10grade-christmas-luck-codey" target='_blank'>Check us out</a></h1>
      </div>
      <img className="w-[100vw] h-[7vh] select-none" src="./src/assets/separator.png" alt="Separator" />
      <div data-aos="fade-down" className="flex items-center justify-center h-[15vh] px-4 mt-40">
        <img
      ...
      <div className="flex justify-center items-center py-48 font-body">
        <img data-aos="fade-up-right" src='./src/assets/leftArrow.png' className='absolute mt-96 left-0' />
        <div data-aos="fade-down-right" className="rounded-[30px] border-[1px] border-[#191A23] bg-white shadow-[0px_5px_0px_0px_#191A23] w-[25vw] h-[63vh] p-8 mx-10">
        ...
        <img data-aos="fade-up-left" src='./src/assets/rightArrow.png' className='absolute mt-2 right-0' />
        <div data-aos="fade-down-left" className="rounded-[30px] border-[1px] border-[#191A23] bg-white shadow-[0px_5px_0px_0px_#191A23] w-[25vw] h-[63vh] p-8 mx-10">
          <h2 className="text-[2.3vw] font-bold">Be a</h2>
      ...
      <div className="flex flex-col items-center justify-center py-16 font-body">
        <h1 data-aos="fade-down" className="text-center text-[2rem] font-bold leading-relaxed">
        ...
        <p data-aos="zoom-in" className="text-center font-light text-[1.2rem] px-4 max-w-[45vw]">
        ...
        <a href="https://github.com/codingburgas/10grade-christmas-luck-codey"><button data-aos="fade-up" className="mt-10 bg-white text-black text-[1.5rem] font-bold px-12 py-4 rounded-full border border-black shadow-[0px_5px_0px_0px_#191A23] 
