...
#include "../../../../../codeyapp/presentationLayer/authwindow.h"
...
static constexpr auto qt_meta_stringdata_ZN10AuthWindowE = QtMocHelpers::stringData(
    "AuthWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10AuthWindowE[] = {
...
Q_CONSTINIT const QMetaObject AuthWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10AuthWindowE.offsetsAndSizes,
    qt_meta_data_ZN10AuthWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10AuthWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *AuthWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10AuthWindowE.stringdata0))
