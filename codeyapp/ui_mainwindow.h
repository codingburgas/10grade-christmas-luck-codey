...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_lampBackground->setObjectName(QString::fromUtf8("label_lampBackground"));
        label_lampBackground->setGeometry(QRect(610, 0, 700, 801));
        label_lampBackground->setCursor(QCursor(Qt::ArrowCursor));
...
"font: 350 11pt \"Segoe UI\";"));
        ...
        label_linesBackground->setObjectName(QString::fromUtf8("label_linesBackground"));
        label_linesBackground->setGeometry(QRect(40, 40, 81, 801));
        label_linesBackground->setCursor(QCursor(Qt::ArrowCursor));
        ...
        label_backgroundText->setObjectName(QString::fromUtf8("label_backgroundText"));
